...
const VirtualizedTrackList = React.lazy(() => import('./VirtualizedTrackList'));
const OptimizedTrackCard = React.lazy(() => import('./OptimizedTrackCard'));
...
const OptimizedTrackLibrary = memo(() => {
...
OptimizedTrackLibrary.displayName = 'OptimizedTrackLibrary';

export default OptimizedTrackLibrary;